...
$e_body = "Usted ha sido contactado por $name_contact $lastname_contact con el siguiente mensaje: " . PHP_EOL . PHP_EOL;
$e_content = "\"$message_contact\"" . PHP_EOL . PHP_EOL;
$e_reply = "Puedes contactar a $lastname_contact via email, $email_contact o via Telefono $phone_contact";
