...
/*		array (
	...
	$cfg['ilibs_dir'] 	   = array('/images/stories/');						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
